...
enum AuthError(url: String, code: String, title: String, message: String)
    extends Problem(url, code, title, message):
  case InvalidToken
      extends AuthError(
  ...
  case UserAlreadyExists
      extends AuthError(
        url = "/problem/auth/user-already-exists",
        code = "AUTH_USER_ALREADY_EXISTS",
        title = "User Already Exists",
        message = "The informed user is already registered!"
      )
