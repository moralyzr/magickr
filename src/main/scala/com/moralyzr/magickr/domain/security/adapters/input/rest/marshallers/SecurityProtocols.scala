package com.moralyzr.magickr.domain.security.adapters.input.rest.marshallers

import cats.effect.kernel.Async
import com.moralyzr.magickr.domain.security.core.errors.{AuthError, InvalidCredentials, InvalidToken, UserAlreadyExists, UserNotFound}
